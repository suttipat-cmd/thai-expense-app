...
- เพิ่ม loading และ disabled state ในจุดสำคัญ เช่น โหลดข้อมูล บันทึก ลบ โหลดใหม่ และ OCR
- ปรับ UI กันล้นกรอบ ทับซ้อน และระยะห่างบนจอมือถือเล็ก
...
5. รอ loading OCR
6. ระบบจะเติมข้อมูลให้ในฟอร์ม โดยตั้งเป็น `รายจ่าย` เสมอ
